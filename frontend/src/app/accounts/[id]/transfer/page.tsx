...
const TransferPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (fromAccount && transferAmount > fromAccount.balance) {
      setError('Insufficient funds. You cannot transfer more than your current balance.');
      return;
    }
    ...
    try {
      const response = await TransactionsAPI.createTransfer(
      ...
      if (response.success) {
        setSuccess(true);
        setTimeout(() => {
          router.push(`/accounts/${fromAccountId}`);
        }, 2000);
      } else {
        setError(response.message || 'Failed to process transfer');
      }
    } catch (err) {
          ...
          <div className="px-4 py-6 sm:px-0">
            ...
            {fromAccount && (
              <div className="bg-white shadow rounded-lg p-6 mb-6">
                <h3 className="text-lg font-medium text-gray-900 mb-4">From Account</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm font-medium text-gray-600">Account Number</p>
                    <p className="text-lg font-semibold text-gray-900">{fromAccount.accountNumber}</p>
                  </div>
                  <div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-sm text-green-700">
                      Your transfer has been processed successfully. Redirecting to account details...
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white shadow rounded-lg">
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-sm text-gray-500">
                    Maximum transfer: {fromAccount ? formatCurrency(fromAccount.balance, fromAccount.currency) : 'N/A'}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g., Transfer to savings, Bill payment"
                    required
                    className="w-full"
                  />
                  <p className="mt-1 text-sm text-gray-500">
                    Brief description of the transfer
                  </p>
                </div>
